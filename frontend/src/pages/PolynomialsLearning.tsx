...
const PolynomialsLearning = () => {
  ...
  const lesson6 = (course as any).real_world_applications?.lessons.lesson6 || polynomialCourse.en.real_world_applications.lessons.lesson6;

  const { openSections, setOpenSections } = useHashScroll({
    "lesson-basics":       "section1-1",
    "lesson-operations":   "section2-1",
    "lesson-factoring":    "section3-1",
    "lesson-roots":        "section4-1",
    "lesson-equations":    "section5-1",
    "lesson-applications": "section6-1",
  });
    ...
    <div className="min-h-screen relative">
      ...
      <main className="container mx-auto px-3 sm:px-4 pt-6 sm:pt-8 pb-12">
        ...
        <div id="lesson-basics" className="max-w-4xl mx-auto mb-12">
          ...
          <Accordion type="multiple" value={openSections["lesson-basics"] ?? ["section1-1"]} onValueChange={v => setOpenSections("lesson-basics", v)} className="space-y-4">
        ...
        <div id="lesson-operations" className="max-w-4xl mx-auto mb-12">
          ...
          <Accordion type="multiple" value={openSections["lesson-operations"] ?? ["section2-1"]} onValueChange={v => setOpenSections("lesson-operations", v)} className="space-y-4">
        ...
        <div id="lesson-factoring" className="max-w-4xl mx-auto mb-12">
          ...
          <Accordion type="multiple" value={openSections["lesson-factoring"] ?? ["section3-1"]} onValueChange={v => setOpenSections("lesson-factoring", v)} className="space-y-4">
            {/* Section 1: GCF */}
        ...
        <div id="lesson-roots" className="max-w-4xl mx-auto mb-12">
          ...
          <Accordion type="multiple" value={openSections["lesson-roots"] ?? ["section4-1"]} onValueChange={v => setOpenSections("lesson-roots", v)} className="space-y-4">
                  ...
                  <div className="border rounded-lg p-4 bg-card mt-4 max-w-2xl mx-auto">
                    ...
                    <div className="w-full bg-muted/20 rounded-lg flex items-center justify-center p-4">
                      <svg viewBox="0 0 320 200" className="w-full max-w-md" preserveAspectRatio="xMidYMid meet">
                        ...
                        <text x="225" y="74" fontSize="12" textAnchor="middle" fill="rgb(21, 128, 61)" fontWeight="bold">(x − 2) {lesson4.section1.plot1_description}</text>
        ...
        <div id="lesson-equations" className="max-w-4xl mx-auto mb-12">
          ...
          <Accordion type="multiple" value={openSections["lesson-equations"] ?? ["section5-1"]} onValueChange={v => setOpenSections("lesson-equations", v)} className="space-y-4">
        ...
        <div id="lesson-applications" className="max-w-4xl mx-auto mb-12">
          <div className="mb-6">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold mb-2">{(course as any).real_world_applications?.title || polynomialCourse.en.real_world_applications.title}</h2>
          ...
          <Accordion type="multiple" value={openSections["lesson-applications"] ?? ["section6-1"]} onValueChange={v => setOpenSections("lesson-applications", v)} className="space-y-4">
            ...
            <AccordionItem value="section6-1" className="border rounded-lg px-6 bg-card">
              ...
              <AccordionContent className="pt-4 space-y-4">
                <p className="text-muted-foreground text-lg">{lesson6.section1.def1_1}</p>
                <p className="text-muted-foreground text-lg">{lesson6.section1.text1_1}</p>
                ...
                {lesson6.section1.plot1_title && (
                  <div className="border rounded-lg p-4 bg-card mt-4 max-w-2xl mx-auto">
                    ...
                    <p className="text-xs text-muted-foreground mb-3">{lesson6.section1.plot1_desc}</p>
                    <div className="w-full bg-muted/20 rounded-lg flex items-center justify-center p-4">
                      <svg viewBox="0 0 320 250" className="w-full max-w-md" preserveAspectRatio="xMidYMid meet">
                        {/* Flat sheet */}
                        <rect x="40" y="20" width="180" height="180" fill="rgb(254, 249, 195)" stroke="currentColor" strokeWidth="1.5" />

                        {/* Corner cuts */}
                        <rect x="40" y="20" width="40" height="40" fill="rgb(254, 202, 202)" stroke="rgb(239, 68, 68)" strokeWidth="1.5" strokeDasharray="4" />
                        <rect x="180" y="20" width="40" height="40" fill="rgb(254, 202, 202)" stroke="rgb(239, 68, 68)" strokeWidth="1.5" strokeDasharray="4" />
                        <rect x="40" y="160" width="40" height="40" fill="rgb(254, 202, 202)" stroke="rgb(239, 68, 68)" strokeWidth="1.5" strokeDasharray="4" />
                        <rect x="180" y="160" width="40" height="40" fill="rgb(254, 202, 202)" stroke="rgb(239, 68, 68)" strokeWidth="1.5" strokeDasharray="4" />

                        {/* Corner labels */}
                        <text x="60" y="45" fontSize="12" textAnchor="middle" fill="rgb(239, 68, 68)" fontWeight="bold">x</text>
                        <text x="200" y="45" fontSize="12" textAnchor="middle" fill="rgb(239, 68, 68)" fontWeight="bold">x</text>
                        <text x="60" y="185" fontSize="12" textAnchor="middle" fill="rgb(239, 68, 68)" fontWeight="bold">x</text>
                        <text x="200" y="185" fontSize="12" textAnchor="middle" fill="rgb(239, 68, 68)" fontWeight="bold">x</text>

                        {/* Fold lines */}
                        <line x1="80" y1="20" x2="80" y2="200" stroke="rgb(59, 130, 246)" strokeWidth="1" strokeDasharray="6" />
                        <line x1="180" y1="20" x2="180" y2="200" stroke="rgb(59, 130, 246)" strokeWidth="1" strokeDasharray="6" />
                        <line x1="40" y1="60" x2="220" y2="60" stroke="rgb(59, 130, 246)" strokeWidth="1" strokeDasharray="6" />
                        <line x1="40" y1="160" x2="220" y2="160" stroke="rgb(59, 130, 246)" strokeWidth="1" strokeDasharray="6" />

                        {/* Dimension labels */}
                        <text x="130" y="12" fontSize="11" textAnchor="middle" fill="currentColor" fontWeight="bold">L</text>
                        <text x="32" y="115" fontSize="11" textAnchor="middle" fill="currentColor" fontWeight="bold">W</text>
                        <text x="130" y="115" fontSize="13" textAnchor="middle" fill="rgb(21, 128, 61)" fontWeight="bold">Base</text>
                        <text x="130" y="132" fontSize="10" textAnchor="middle" fill="rgb(21, 128, 61)">(L-2x) × (W-2x)</text>

                        {/* Arrow to 3D box */}
                        <text x="260" y="90" fontSize="22" textAnchor="middle" fill="currentColor">→</text>

                        {/* Simple 3D box representation */}
                        <g transform="translate(265, 60)">
                          {/* Front face */}
                          <rect x="0" y="30" width="40" height="40" fill="rgb(187, 247, 208)" stroke="currentColor" strokeWidth="1.5" />
                          {/* Top face */}
                          <polygon points="0,30 15,15 55,15 40,30" fill="rgb(134, 239, 172)" stroke="currentColor" strokeWidth="1.5" />
                          {/* Right face */}
                          <polygon points="40,30 55,15 55,55 40,70" fill="rgb(74, 222, 128)" stroke="currentColor" strokeWidth="1.5" />
                          {/* Height label */}
                          <text x="-8" y="55" fontSize="10" fill="rgb(239, 68, 68)" fontWeight="bold">x</text>
                        </g>

                        {/* Caption */}
                        <text x="160" y="230" fontSize="11" textAnchor="middle" fill="currentColor" fontStyle="italic">{lesson6.section1.caption}</text>
                      </svg>
                    </div>
                  </div>
                )}

                <p className="text-muted-foreground text-lg" dangerouslySetInnerHTML={{ __html: renderTextWithMath(lesson6.section1.text1_2) }} />
              </AccordionContent>
            </AccordionItem>

            {/* Section 2: Motion Problems */}
            <AccordionItem value="section6-2" className="border rounded-lg px-6 bg-card">
              ...
              <AccordionContent className="pt-4 space-y-4">
                <p className="text-muted-foreground text-lg">{lesson6.section2.def2_1}</p>

                <div className="my-4 p-4 bg-muted/30 rounded-lg overflow-x-auto">
                  <div dangerouslySetInnerHTML={{ __html: renderMath(lesson6.section2.math2_1) }} />
                </div>
                <div className="my-4 p-4 bg-muted/30 rounded-lg overflow-x-auto">
                  <div dangerouslySetInnerHTML={{ __html: renderMath(lesson6.section2.math2_2) }} />
                </div>

                <ul className="list-disc list-inside space-y-2 ml-4">
                  <li className="text-muted-foreground text-lg" dangerouslySetInnerHTML={{ __html: renderTextWithMath(lesson6.section2.list2_1) }} />
                  <li className="text-muted-foreground text-lg" dangerouslySetInnerHTML={{ __html: renderTextWithMath(lesson6.section2.list2_2) }} />
                  <li className="text-muted-foreground text-lg" dangerouslySetInnerHTML={{ __html: renderTextWithMath(lesson6.section2.list2_3) }} />
                </ul>

                {/* Projectile Trajectory Visual */}
                {lesson6.section2.plot2_title && (
                  <div className="border rounded-lg p-4 bg-card mt-4 max-w-2xl mx-auto">
                    <h5 className="font-semibold text-sm mb-2">{lesson6.section2.plot2_title}</h5>
                    <p className="text-xs text-muted-foreground mb-3">{lesson6.section2.plot2_desc}</p>
                    <div className="w-full bg-muted/20 rounded-lg flex items-center justify-center p-4">
                      <svg viewBox="0 0 320 200" className="w-full max-w-md" preserveAspectRatio="xMidYMid meet">
                        {/* Ground */}
                        <line x1="30" y1="170" x2="300" y2="170" stroke="currentColor" strokeWidth="1.5" />
                        {/* Y-axis */}
                        <line x1="30" y1="10" x2="30" y2="170" stroke="currentColor" strokeWidth="1" strokeDasharray="4" opacity="0.3" />

                        {/* Parabolic arc */}
                        <path d="M 30 160 Q 70 100, 110 45 Q 150 5, 190 45 Q 230 100, 280 170" fill="none" stroke="rgb(59, 130, 246)" strokeWidth="2.5" />

                        {/* Start point (h0 > 0) */}
                        <circle cx="30" cy="160" r="5" fill="rgb(34, 197, 94)" stroke="white" strokeWidth="2" />
                        <text x="30" y="188" fontSize="9" textAnchor="middle" fill="rgb(21, 128, 61)" fontWeight="bold">Start (h₀)</text>

                        {/* Max height */}
                        <circle cx="150" cy="20" r="5" fill="rgb(168, 85, 247)" stroke="white" strokeWidth="2" />
                        <text x="150" y="13" fontSize="9" textAnchor="middle" fill="rgb(126, 34, 206)" fontWeight="bold">{lesson6.section2.max_height}</text>
                        <line x1="150" y1="25" x2="150" y2="170" stroke="rgb(168, 85, 247)" strokeWidth="1" strokeDasharray="3" opacity="0.4" />

                        {/* Impact point */}
                        <circle cx="280" cy="170" r="5" fill="rgb(239, 68, 68)" stroke="white" strokeWidth="2" />
                        <text x="280" y="188" fontSize="9" textAnchor="middle" fill="rgb(239, 68, 68)" fontWeight="bold">{lesson6.section2.impact} (h=0)</text>

                        {/* Axis labels */}
                        <text x="300" y="166" fontSize="10" fill="currentColor">t</text>
                        <text x="20" y="15" fontSize="10" fill="currentColor">h</text>

                        {/* Gravity arrow */}
                        <text x="200" y="60" fontSize="10" fill="currentColor" opacity="0.6">↓ {lesson6.section2.gravity}</text>
                      </svg>
                    </div>
                  </div>
                )}
            ...
            <AccordionItem value="section6-3" className="border rounded-lg px-6 bg-card">
              ...
              <AccordionContent className="pt-4 space-y-4">
                <p className="text-muted-foreground text-lg">{lesson6.section3.def3_1}</p>
                ...
                <ul className="list-disc list-inside space-y-2 ml-4">
                  <li className="text-muted-foreground text-lg" dangerouslySetInnerHTML={{ __html: renderTextWithMath(lesson6.section3.list3_1) }} />
                  <li className="text-muted-foreground text-lg" dangerouslySetInnerHTML={{ __html: renderTextWithMath(lesson6.section3.list3_2) }} />
                  <li className="text-muted-foreground text-lg" dangerouslySetInnerHTML={{ __html: renderTextWithMath(lesson6.section3.list3_3) }} />
                </ul>

                {/* Profit Analysis Visual */}
                {lesson6.section3.plot3_title && (
                  <div className="border rounded-lg p-4 bg-card mt-4 max-w-2xl mx-auto">
                    <h5 className="font-semibold text-sm mb-2">{lesson6.section3.plot3_title}</h5>
                    <p className="text-xs text-muted-foreground mb-3">{lesson6.section3.plot3_desc}</p>
                    <div className="w-full bg-muted/20 rounded-lg flex items-center justify-center p-4">
                      <svg viewBox="0 0 320 220" className="w-full max-w-md" preserveAspectRatio="xMidYMid meet">
                        {/* Axes */}
                        <line x1="40" y1="180" x2="300" y2="180" stroke="currentColor" strokeWidth="1.5" />
                        <line x1="40" y1="10" x2="40" y2="180" stroke="currentColor" strokeWidth="1.5" />

                        {/* Revenue curve (parabola opening down) */}
                        <path d="M 40 180 Q 100 40, 170 20 Q 240 40, 290 180" fill="none" stroke="rgb(59, 130, 246)" strokeWidth="2" />
                        <text x="175" y="14" fontSize="10" fill="rgb(59, 130, 246)" fontWeight="bold">{lesson6.section3.revenue} R(x)</text>

                        {/* Cost line (linear) */}
                        <path d="M 40 140 L 290 60" fill="none" stroke="rgb(239, 68, 68)" strokeWidth="2" strokeDasharray="5" />
                        <text x="260" y="53" fontSize="10" fill="rgb(239, 68, 68)" fontWeight="bold">{lesson6.section3.cost} C(x)</text>

                        {/* Profit region (shaded area between curves) */}
                        <path d="M 80 155 Q 130 60, 170 45 Q 210 60, 240 110" fill="rgb(34, 197, 94)" fillOpacity="0.15" stroke="none" />
                        <text x="165" y="90" fontSize="10" fill="rgb(21, 128, 61)" fontWeight="bold">{lesson6.section3.profit}</text>

                        {/* Break-even points */}
                        <circle cx="80" cy="155" r="5" fill="rgb(251, 146, 60)" stroke="white" strokeWidth="2" />
                        <text x="80" y="200" fontSize="9" textAnchor="middle" fill="rgb(234, 88, 12)" fontWeight="bold">{lesson6.section3.break_even}</text>

                        <circle cx="240" cy="110" r="5" fill="rgb(251, 146, 60)" stroke="white" strokeWidth="2" />
                        <text x="240" y="200" fontSize="9" textAnchor="middle" fill="rgb(234, 88, 12)" fontWeight="bold">{lesson6.section3.break_even}</text>

                        {/* Max profit marker */}
                        <circle cx="165" cy="50" r="4" fill="rgb(34, 197, 94)" stroke="white" strokeWidth="2" />
                        <line x1="165" y1="54" x2="165" y2="80" stroke="rgb(34, 197, 94)" strokeWidth="1" strokeDasharray="3" />

                        {/* Labels */}
                        <text x="295" y="176" fontSize="10" fill="currentColor">x</text>
                        <text x="44" y="15" fontSize="10" fill="currentColor">$</text>
                      </svg>
                    </div>
                  </div>
                )}
                ...
                <p className="text-muted-foreground text-lg">{lesson6.section3.text3_2}</p>
                ...
                <div className="my-4 p-4 bg-blue-500/5 border border-blue-500/20 rounded-lg">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-muted-foreground text-lg" dangerouslySetInnerHTML={{ __html: renderTextWithMath(lesson6.section3.ex3_1_step3) }} />
                    <p className="font-semibold text-lg text-green-700 dark:text-green-400 mt-2">{lesson6.section3.ex3_1_solution}</p>
                  </div>
                </div>
              </AccordionContent>
            </AccordionItem>

            {/* Section 4: Engineering & Data Modeling */}
            <AccordionItem value="section6-4" className="border rounded-lg px-6 bg-card">
              ...
              <AccordionContent className="pt-4 space-y-4">
                <p className="text-muted-foreground text-lg">{lesson6.section4.def4_1}</p>

                {/* Curve Fitting Visual */}
                {lesson6.section4.plot4_title && (
                  <div className="border rounded-lg p-4 bg-card mt-4 max-w-2xl mx-auto">
                    <h5 className="font-semibold text-sm mb-2">{lesson6.section4.plot4_title}</h5>
                    <p className="text-xs text-muted-foreground mb-3">{lesson6.section4.plot4_desc}</p>
                    <div className="w-full bg-muted/20 rounded-lg flex items-center justify-center p-4">
                      <svg viewBox="0 0 320 220" className="w-full max-w-md" preserveAspectRatio="xMidYMid meet">
                        {/* Axes */}
                        <line x1="40" y1="190" x2="300" y2="190" stroke="currentColor" strokeWidth="1.5" />
                        <line x1="40" y1="10" x2="40" y2="190" stroke="currentColor" strokeWidth="1.5" />

                        {/* Fitted curve (y = x² + 1) */}
                        <path d="M 50 180 Q 90 168, 120 145 Q 160 100, 200 50 Q 230 15, 270 -20" fill="none" stroke="rgb(59, 130, 246)" strokeWidth="2" clipPath="url(#data-clip)" />
                        <defs>
                          <clipPath id="data-clip">
                            <rect x="40" y="10" width="260" height="180" />
                          </clipPath>
                        </defs>

                        {/* Data points */}
                        <circle cx="80" cy="170" r="6" fill="rgb(239, 68, 68)" stroke="white" strokeWidth="2" />
                        <text x="80" y="165" fontSize="9" textAnchor="middle" fill="rgb(239, 68, 68)">(1,2)</text>

                        <circle cx="120" cy="145" r="6" fill="rgb(239, 68, 68)" stroke="white" strokeWidth="2" />
                        <text x="120" y="140" fontSize="9" textAnchor="middle" fill="rgb(239, 68, 68)">(2,5)</text>

                        <circle cx="160" cy="100" r="6" fill="rgb(239, 68, 68)" stroke="white" strokeWidth="2" />
                        <text x="160" y="95" fontSize="9" textAnchor="middle" fill="rgb(239, 68, 68)">(3,10)</text>

                        <circle cx="200" cy="50" r="6" fill="rgb(239, 68, 68)" stroke="white" strokeWidth="2" />
                        <text x="200" y="45" fontSize="9" textAnchor="middle" fill="rgb(239, 68, 68)">(4,17)</text>

                        {/* Prediction point */}
                        <circle cx="240" cy="20" r="6" fill="rgb(34, 197, 94)" stroke="white" strokeWidth="2" strokeDasharray="3" />
                        <text x="240" y="15" fontSize="9" textAnchor="middle" fill="rgb(21, 128, 61)" fontWeight="bold">(5,26)?</text>

                        {/* Labels */}
                        <text x="260" y="210" fontSize="10" fill="rgb(59, 130, 246)" fontWeight="bold">y = x² + 1</text>
                        <text x="295" y="186" fontSize="10" fill="currentColor">x</text>
                        <text x="44" y="15" fontSize="10" fill="currentColor">y</text>

                        {/* Legend */}
                        <circle cx="250" cy="165" r="4" fill="rgb(239, 68, 68)" />
                        <text x="260" y="168" fontSize="9" fill="currentColor">{lesson6.section4.data}</text>
                        <circle cx="250" cy="175" r="4" fill="rgb(34, 197, 94)" />
                        <text x="260" y="178" fontSize="9" fill="currentColor">{lesson6.section4.prediction}</text>
                      </svg>
                    </div>
                  </div>
                )}

                <p className="text-muted-foreground text-lg">{lesson6.section4.text4_1}</p>

                <div className="mt-4 p-4 bg-yellow-500/10 border border-yellow-500/20 rounded-lg">
                  <p className="text-muted-foreground text-lg" dangerouslySetInnerHTML={{ __html: renderTextWithMath(lesson6.section4.warning4_1) }} />
                </div>

                {/* Example: Pattern Recognition */}
                <div className="my-4 p-4 bg-blue-500/5 border border-blue-500/20 rounded-lg">
                  <h5 className="font-semibold text-blue-700 dark:text-blue-400 mb-2">{lesson6.section4.ex4_1_title}</h5>
                  <p className="text-muted-foreground text-lg mb-2">{lesson6.section4.ex4_1_problem}</p>
                  <div className="space-y-1">
                    ...
                    <p className="text-muted-foreground text-lg" dangerouslySetInnerHTML={{ __html: renderTextWithMath(lesson6.section4.ex4_1_step3) }} />
            ...
            <AccordionItem value="section6-examples" className="border rounded-lg px-6 bg-card">
              ...
              <AccordionContent className="pt-4">
                ...
                <div className="mb-6 pb-6 border-b">
                  ...
                  <p className="text-muted-foreground text-lg mb-2" dangerouslySetInnerHTML={{ __html: renderTextWithMath(lesson6.example_section.ex1.problem) }} />
                  <div className="my-3 p-3 bg-muted/30 rounded-lg overflow-x-auto">
                  ...
                  <div className="space-y-3">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground text-lg" dangerouslySetInnerHTML={{ __html: renderTextWithMath(lesson6.example_section.ex1.step2_desc) }} />
                      <div className="my-2 p-3 bg-muted/30 rounded-lg overflow-x-auto">
                    ...
                    <div>
                      ...
                      <div className="my-2 p-3 bg-muted/30 rounded-lg overflow-x-auto">
                        <div dangerouslySetInnerHTML={{ __html: renderMath(lesson6.example_section.ex1.step3_math) }} />
                      </div>
                    </div>
                    <div className="p-4 bg-green-500/10 border border-green-500/20 rounded-lg">
                      <p className="font-semibold text-lg text-green-700 dark:text-green-400">{lesson6.example_section.ex1.result_title}</p>
                      <p className="text-muted-foreground text-lg">{lesson6.example_section.ex1.result}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="mb-6 pb-6 border-b">
                  ...
                  <p className="text-muted-foreground text-lg mb-2" dangerouslySetInnerHTML={{ __html: renderTextWithMath(lesson6.example_section.ex2.problem) }} />
                  <div className="space-y-3">
                    <div>
                      <p className="font-semibold text-lg">{lesson6.example_section.ex2.step1_title}</p>
                      <p className="text-muted-foreground text-lg">{lesson6.example_section.ex2.step1_desc}</p>
                    </div>
                    <div>
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground text-lg" dangerouslySetInnerHTML={{ __html: renderTextWithMath(lesson6.example_section.ex2.step3_desc) }} />
                      <div className="my-2 p-3 bg-muted/30 rounded-lg overflow-x-auto">
                    ...
                    <div className="p-4 bg-green-500/10 border border-green-500/20 rounded-lg">
                      ...
                      <p className="text-muted-foreground text-lg">{lesson6.example_section.ex2.result}</p>
                    </div>
                  </div>
                </div>

                {/* Example 3: Volume Construction */}
                <div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground text-lg">{lesson6.example_section.ex3.step3_desc}</p>
                    </div>
                    <div className="p-4 bg-green-500/10 border border-green-500/20 rounded-lg">
