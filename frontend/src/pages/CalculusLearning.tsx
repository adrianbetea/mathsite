              ...
              <AccordionContent className="pt-4 space-y-8">
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    <div>
                      <p className="font-semibold" dangerouslySetInnerHTML={{ __html: renderTextWithMath(lesson1.example_section.ex1.step1_title) }} />
                      <p className="text-muted-foreground text-sm" dangerouslySetInnerHTML={{ __html: renderTextWithMath(lesson1.example_section.ex1.step1_desc) }} />
                    </div>
                    <div>
                      <p className="font-semibold" dangerouslySetInnerHTML={{ __html: renderTextWithMath(lesson1.example_section.ex1.step2_title) }} />
                    ...
                    <div>
                      <p className="font-semibold" dangerouslySetInnerHTML={{ __html: renderTextWithMath(lesson1.example_section.ex1.step3_title) }} />
                      <p className="text-muted-foreground text-sm" dangerouslySetInnerHTML={{ __html: renderTextWithMath(lesson1.example_section.ex1.step3_desc) }} />
                      <div className="my-2 p-3 bg-muted/30 rounded-lg overflow-x-auto">
                        <div dangerouslySetInnerHTML={{ __html: renderMath(lesson1.example_section.ex1.step3_math) }} />
                      </div>
                    </div>
                    <div className="p-4 bg-green-500/10 border border-green-500/20 rounded-lg">
                      <p className="font-semibold text-green-700 dark:text-green-400">{lesson1.example_section.ex1.result_title}</p>
                      <p className="text-muted-foreground" dangerouslySetInnerHTML={{ __html: renderTextWithMath(lesson1.example_section.ex1.result) }} />
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    <div>
                      <p className="font-semibold" dangerouslySetInnerHTML={{ __html: renderTextWithMath(lesson1.example_section.ex2.step1_title) }} />
                      <p className="text-muted-foreground text-sm" dangerouslySetInnerHTML={{ __html: renderTextWithMath(lesson1.example_section.ex2.step1_desc) }} />
                    </div>
                    <div>
                      <p className="font-semibold" dangerouslySetInnerHTML={{ __html: renderTextWithMath(lesson1.example_section.ex2.step2_title) }} />
                      <p className="text-muted-foreground text-sm" dangerouslySetInnerHTML={{ __html: renderTextWithMath(lesson1.example_section.ex2.step2_desc) }} />
                      <div className="my-2 p-3 bg-muted/30 rounded-lg overflow-x-auto">
                        <div dangerouslySetInnerHTML={{ __html: renderMath(lesson1.example_section.ex2.step2_math) }} />
                      </div>
                    </div>
                    <div>
                      <p className="font-semibold" dangerouslySetInnerHTML={{ __html: renderTextWithMath(lesson1.example_section.ex2.step3_title) }} />
                      <p className="text-muted-foreground text-sm" dangerouslySetInnerHTML={{ __html: renderTextWithMath(lesson1.example_section.ex2.step3_desc) }} />
                      <div className="my-2 p-3 bg-muted/30 rounded-lg overflow-x-auto">
                        <div dangerouslySetInnerHTML={{ __html: renderMath(lesson1.example_section.ex2.step3_math) }} />
                      </div>
                    </div>
                    <div className="p-4 bg-green-500/10 border border-green-500/20 rounded-lg">
                      <p className="font-semibold text-green-700 dark:text-green-400">{lesson1.example_section.ex2.result_title}</p>
                      <p className="text-muted-foreground" dangerouslySetInnerHTML={{ __html: renderTextWithMath(lesson1.example_section.ex2.result) }} />
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-3">
                    <div>
                      <p className="font-semibold" dangerouslySetInnerHTML={{ __html: renderTextWithMath(lesson1.example_section.ex3.step1_title) }} />
                      <p className="text-muted-foreground text-sm" dangerouslySetInnerHTML={{ __html: renderTextWithMath(lesson1.example_section.ex3.step1_desc) }} />
                    </div>
                    <div>
                      <p className="font-semibold" dangerouslySetInnerHTML={{ __html: renderTextWithMath(lesson1.example_section.ex3.step2_title) }} />
                      <div className="my-2 p-3 bg-muted/30 rounded-lg overflow-x-auto">
                        <div dangerouslySetInnerHTML={{ __html: renderMath(lesson1.example_section.ex3.step2_math) }} />
                      </div>
                    </div>
                    <div>
                      <p className="font-semibold" dangerouslySetInnerHTML={{ __html: renderTextWithMath(lesson1.example_section.ex3.step3_title) }} />
                      <p className="text-muted-foreground text-sm" dangerouslySetInnerHTML={{ __html: renderTextWithMath(lesson1.example_section.ex3.step3_desc) }} />
                    </div>
                    <div className="p-4 bg-green-500/10 border border-green-500/20 rounded-lg">
                      <p className="font-semibold text-green-700 dark:text-green-400">{lesson1.example_section.ex3.result_title}</p>
                      <p className="text-muted-foreground" dangerouslySetInnerHTML={{ __html: renderTextWithMath(lesson1.example_section.ex3.result) }} />
                    </div>
                  </div>
                </div>
              </AccordionContent>
